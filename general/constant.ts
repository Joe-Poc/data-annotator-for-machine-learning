...
export let Constant = {
  ...
  firstname: "poc",
  lastname: "os",
  username: process.env.TEST_USER_NAME || "poc-os@poc-os.com",
  fullname: process.env.TEST_FULL_NAME || "Poc Os",
  password: process.env.TEST_PASSWORD ||"Abcd1234@",
  username2: process.env.TEST_USER_NAME_2 || "test2@vmware.com",
